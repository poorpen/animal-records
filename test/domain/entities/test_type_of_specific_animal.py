...
def test_change_animal_type_negative_first(animal, old_type_id, new_type_id):
    animal.add_animal_type(TypeOfSpecificAnimal(animal_id=animal.id, animal_type_id=old_type_id))
    animal.add_animal_type(TypeOfSpecificAnimal(animal_id=animal.id, animal_type_id=new_type_id))
...
def test_change_type_positive(animal, old_type_id, new_type_id):
    ...
    animal.add_animal_type(animal_type)
...
def test_delete_type_negative_first(animal):
    animal_typeid = 5
    animal.add_animal_type(TypeOfSpecificAnimal(animal_id=animal.id, animal_type_id=animal_typeid))
...
def test_delete_animal_positive(animal):
    ...
    animal.add_animal_type(first_animal_type)
    animal.add_animal_type(second_animal_type)
